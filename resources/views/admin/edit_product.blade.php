                ...
                <div class="panel-body">
                    ...
                    @foreach($edit_product as $key => $edit_pro)
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{URL::to('uploads/product/'.$edit_pro->product_image)}}" height="250px" width="250px">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="6" class="form-control" name= "product_desc" id="exampleInputPassword1" >{{$edit_pro->product_desc}}
                            </textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Chi tiết sản phẩm</label>
                            <textarea style="resize: none" rows="6" class="form-control" name= "product_content" id="exampleInputPassword1" >{{$edit_pro->product_content}}
                            </textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="resize: none" rows="6" class="form-control" name= "product_promotion" id="exampleInputPassword1">{{$edit_pro->product_promotion}}
                                </textarea>
                            </div>
                            <div class="form-group">
