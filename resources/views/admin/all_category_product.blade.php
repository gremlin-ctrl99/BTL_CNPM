        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc muốn xóa ?')" href="{{URL::to('/delete-category-product/').$cate_pro->category_id}}" class="active active styling_edit" ui-toggle-class="">
